...
>
    ...
    <option key={t.label} value={t.label}>
      {t.label}{t.fee ? " (+$100)" : ""}
            ...
            <div className="mt-4 space-y-3 text-sm">
              <label className="flex items-center gap-2 relative group cursor-pointer">
  <input
    type="checkbox"
    checked={stairsFee}
  ...
  {/* Tooltip */}
  <div className="absolute left-0 top-8 w-64 bg-black text-white text-xs rounded-lg px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 shadow-lg">
    Please make sure the stairs or elevator can accommodate the rental items 
    and that they fit properly inside your apartment or event venue.
  </div>
</label>
